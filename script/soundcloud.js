...
function soundcloud(){
  ...
  this.startPlayer = function(id){
    var playerDiv = $("#playerDiv");
    playerDiv.html('<iframe id="player1" width="100%" height="100%" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/'+id+'&amp;auto_play=true&amp;hide_related=true&amp;show_comments=false&amp;show_user=false&amp;show_reposts=false&amp;color=E9E9E9&amp;buying=false&amp;sharing=false&amp;download=false&amp;theme_color=000000&amp;show_artwork=false"></iframe>');
    isActive = true;
